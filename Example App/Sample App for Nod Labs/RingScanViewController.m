//
//  RingScanViewController.m
//  Light-Controller
//
//  Copyright (c) 2014 ënimai Inc. All rights reserved.
//

#import "RingScanViewController.h"

@interface RingScanViewController ()
...
@implementation RingScanViewController
...
{
    static NSString *CellIdentifier = @"DeviceCellPrototype";
