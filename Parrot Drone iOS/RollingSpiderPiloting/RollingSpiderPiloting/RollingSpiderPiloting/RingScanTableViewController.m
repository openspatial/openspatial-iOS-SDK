...
{
    if([segue.identifier  isEqual: @"cancelSegue"]) {
        PilotingViewController *dest = (PilotingViewController*)[segue destinationViewController];
        dest.HIDServ = self.myHIDServ;
        
        [dest setService:self.holdService];
    }
    else {
